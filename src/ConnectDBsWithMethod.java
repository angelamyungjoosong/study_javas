...
public class ConnectDBsWithMethod {
    public static void main(String[] args) {
        ...
        try {
            ...
            // - query Edit
          statement = connection.createStatement(); //쿼리문 넣는 editor 창 
            //statement, query 재사용, resultSet도. 
            //statement,query 사용하면 resultset뱉어내는 거 fuction으로 만들기 

            // parameter을 url, user,  password로 넘기고 결과값을 statement로 받기 

            String query = "SELECT * FROM factorys";
            FactoryDMLs factoryDMLs = new FactoryDMLs();
            ResultSet resultSet = factoryDMLs.selectStatements(statement,query);// resultset은 재활용 가능
            ...
            // 변수로 만들어주고 query에 넣는게 좋음. 쿼리 뒤에 띄어쓰기 한 번씩 하기
            ...
            int count = factoryDMLs.insertStatements(statement, query);// intert update delete는 executeupdate쓴다. select문 빼고.
                System.out.println();
            ...
            //메모리 빼고는 다 반납해야함(connection과 statement...역순으로 반납 )
        }
        System.out.println();
    }
}
